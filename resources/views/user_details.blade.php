          ...
          <section class="row g-3">
            <div class="col-12 col-xl-4">
              <div class="panel h-100 text-center profile-card">
                <div class="profile-cover"><img src="{{ asset('assets/images/png/dasher-ui-bootstrap-5.jpg') }}" alt="User workspace preview"></div>
                <div class="profile-hero">
                  <img class="avatar-img avatar-xl profile-photo" src="{{ asset('assets/images/avatar/' . ($user->avatar ?? 'default.png')) }}" alt="{{ $user->name }}">
                  <h2 class="h5 mb-1">{{ $user->name }}</h2>
                  <p class="text-muted mb-3">{{ $user->role ?? 'User' }}</p>
                  <span class="badge text-bg-success">{{ $user->status ?? 'Active' }} Account</span>
                </div>
            ...
            <div class="col-12 col-xl-8">
                ...
                <div class="panel-header"><div><h2 class="h5 mb-1 section-title"><i class="bi bi-person-lines-fill" aria-hidden="true"></i><span>Account Overview</span></h2><p class="text-muted mb-0">Permissions, plan, and current access details.</p></div><a class="btn btn-primary btn-sm" href="{{ route('users.edit', $user->id) }}"><i class="bi bi-pencil" aria-hidden="true"></i> Edit User</a></div>
                <div class="row g-3">
                  <div class="col-md-4"><div class="mini-card"><span>Role</span><strong>{{ $user->role ?? 'User' }}</strong></div></div>
                  <div class="col-md-4"><div class="mini-card"><span>Last Login</span><strong>{{ $user->last_login ?? 'N/A' }}</strong></div></div>
                  <div class="col-md-4"><div class="mini-card"><span>Projects</span><strong>—</strong></div></div>
                </div>
              </div>
              <div class="panel">
